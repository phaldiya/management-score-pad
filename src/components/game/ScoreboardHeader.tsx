  ...
  return (
    <thead>
      <tr className="sticky top-0 z-20 bg-gray-600">
        <th
          scope="col"
          className="sticky left-0 z-30 w-[49px] border border-gray-500 bg-gray-600 px-1 py-2 text-center font-semibold text-gray-300 text-xs uppercase tracking-wider"
        >
          Play
        </th>
